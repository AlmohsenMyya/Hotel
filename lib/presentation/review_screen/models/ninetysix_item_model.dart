import '../../../core/app_export.dart';/// This class is used in the [ninetysix_item_widget] screen.
class NinetysixItemModel {NinetysixItemModel({this.jennyWilson, this.jennyWilson1, this.dec, this.veryniceandcomfortab, this.id, }) { jennyWilson = jennyWilson  ?? Rx(ImageConstant.imgEllipse1);jennyWilson1 = jennyWilson1  ?? Rx("Jenny Wilson");dec = dec  ?? Rx("Dec 10, 2024");veryniceandcomfortab = veryniceandcomfortab  ?? Rx("Very nice and comfortable hotel, thank you for accompanying my vacation!");id = id  ?? Rx(""); }
